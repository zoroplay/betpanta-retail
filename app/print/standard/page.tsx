  ...
  return (
    <div className="p-4">
      <div className="">
        ...
        {/* Table Card */}
        <BaseCard title="Football Prematch">
        ...
        {/* Table Footer */}
        <div className="bg-[#eaf3fa] font-semibold text-gray-600 px-4 py-3 flex flex-col md:flex-row justify-between items-center text-sm">
          <span className="">
