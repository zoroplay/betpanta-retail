    ...
    <div className="p-4">
      <div className="">
        ...
        <div className="bg-white rounded-lg shadow-sm overflow-hidden border">
          {/* Table Header */}
          <div className="bg-black text-xs text-white text-sm font-semibold grid grid-cols-6">
            <div className="py-2 px-4">Transaction ID</div>
            <div className="py-2 px-4 border-l border-gray-700">
              Description
            </div>
            <div className="py-2 px-4 border-l border-gray-700">Amount</div>
            <div className="py-2 px-4 border-l border-gray-700">Status</div>
            <div className="py-2 px-4 border-l border-gray-700">Balance</div>
            <div className="py-2 px-4 border-l border-gray-700 flex justify-end items-center">
              Date
            </div>
          </div>
          {/* Table Rows */}
          ...
          {/* Table Footer */}
          <div className="bg-[#eaf3fa] text-gray-600 px-4 py-3 flex flex-col md:flex-row justify-between items-center text-sm">
            <span className="">
