...
const Select: React.FC<SelectProps> = ({
  ...
  const inputStyle = `flex w-full ${rounded} border text-inherit ring-offset-background file:border-0 file:text-xs file:font-medium placeholder:text-muted-foreground focus-within:outline-none focus-within:ring-2 focus:outline-none focus:ring-2 focus-within:ring-ring focus-within:ring-offset-0 focus-within:bg-smalltext/10 focus:ring-blue-500/80  focus:ring-2 focus:border-blue-500/80 focus:ring-blue-500/80 focus-within:border-blue-500/80 disabled:cursor-not-allowed disabled:opacity-50 transition-all  hover:bg-btnblue/10 ${
